...
In order to make a **reflection transformation** of a vector (to the other side of a plane), we decompose the vector in  parallel and perpendicular components (relative to the vector _n_, normal to the plane). The parallel component is conserved, while the perpendicular component changes its sign. 
<div align="center">
...
<div align="center">
    <img src="pngs/fig14-matriz-vista-2.png" width="400px"</img>
</div>

<h2>Figure 13</h2>

<div align="center">
    <img src="pngs/fig13-matriz-vista-1.png" width="400px"</img>
</div>
